...
class LivePanel(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.live_metronome = MetronomeIndicator("METRONOME")
        ...
        level_panel = SectionPanel("INPUT LEVEL")
        ...
        timing_panel = SectionPanel("TEMPO MULTIPLIERS")
        ...
        history_panel = SectionPanel("BPM HISTORY")
